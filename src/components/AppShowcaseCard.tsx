      ...
      <div className="card p-8 mb-8">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-gray-600 text-sm">(4.9/5 من 1,247 مراجعة)</span>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900">تحميل التطبيق</h3>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {features.map((feature, index) => (
              <div
                key={index}
                className="flex items-start gap-3 p-4 bg-white rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-300"
              >
        ...
        <div className="bg-gray-50 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900">كيفية الحصول على التطبيق</h3>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-gray-200">
            <button className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-xl hover:from-blue-700 hover:to-blue-800 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
              طلب عرض سعر
            </button>
            <button className="flex-1 px-6 py-3 bg-white text-gray-700 font-medium rounded-xl border border-gray-300 hover:bg-gray-50 hover:border-gray-400 transform hover:scale-105 transition-all duration-300 shadow-sm hover:shadow-md">
              تواصل معنا
            </button>
          </div>
        </div>
